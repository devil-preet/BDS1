...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFF00FF00);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFB10000);
  late Color secondary = const Color(0xFF00B100);
  late Color tertiary = const Color(0xFFE0E0E0);
  late Color alternate = const Color(0xFFB10000);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFFFFFFFF);
  late Color primaryBackground = const Color(0xFFE0E0E0);
  late Color secondaryBackground = const Color(0xFFBDBDBD);
  late Color accent1 = const Color(0xFFB10000);
  late Color accent2 = const Color(0xFF00B100);
  late Color accent3 = const Color(0xFFE0E0E0);
  late Color accent4 = const Color(0xFFE0E0E0);
  late Color success = const Color(0xFF00B100);
  late Color warning = const Color(0xFFB1B100);
  late Color error = const Color(0xFFB10000);
  late Color info = const Color(0xFF0000B1);
